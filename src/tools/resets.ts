...
export const rtlCheckResetsSchema = z.object({
  verilog_sources: z
    .array(z.string())
    .min(1)
    .describe('List of Verilog/SystemVerilog source files to audit for reset usage'),
  top_module: z
    .string()
    .optional()
...
export async function handleRtlCheckResets(
  runner: ToolRunner,
  args: z.infer<typeof rtlCheckResetsSchema>
) {
      ...
      content: [
        {
          ...
          text: JSON.stringify(
            {
              passed: false,
              totalSequentialBlocks: 0,
              blocksWithReset: 0,
              blocksMissingReset: 0,
